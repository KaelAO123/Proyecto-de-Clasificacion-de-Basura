...
- Arquitectura y flujo general: [architecture.md](architecture.md)
- Instalación y preparación del entorno: [setup.md](setup.md)
- Preparación de datos: [setup.md#preparación-de-datos]
- Entrenamiento del modelo: [training.md](training.md)
- Evaluación y reportes: [reports.md](reports.md)
- Inferencia y uso con cámara: [inference.md](inference.md)
- Configuración (YAML): [configuration.md](configuration.md)
- Referencia por módulo (`src/`):
  - [camera_classifier.md](src/camera_classifier.md)
  - [check_ready.md](src/check_ready.md)
  - [data_augmentation.md](src/data_augmentation.md)
  - [data_generators.md](src/data_generators.md)
  - [data_loader.md](src/data_loader.md)
  - [data_preprocessing.md](src/data_preprocessing.md)
  - [iphone.md](src/iphone.md)
  - [model_builder.md](src/model_builder.md)
  - [model_evaluation.md](src/model_evaluation.md)
  - [model_training.md](src/model_training.md)
  - [model_utils.md](src/model_utils.md)

## Documento del proyecto

- Documento narrativo con propósito, objetivos, justificación y diseño: [proyecto.md](proyecto.md)
